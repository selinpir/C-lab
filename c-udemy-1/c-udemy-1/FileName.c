...
//sqrt:karekok
// pow (x,y)-->sayýnýn karesini alýr.
// devam edip etmeme gibi durumlar do while ile yapýlýr.
...
{
	printf("carpim deðeri negatiftir.");
}*/

//3 üçgenin Eþitkenar Ýkizkenar Çeþitkenar Olduðunu Belirleyen Program
/* 	int aci1, aci2, aci3;
...
//4 telefon faturasý görüþme ücreti hesaplama	
/*
float sure, ucret;
 ...
 */
 ...
 //6 Girilen Harfin Alfabede Kaçýncý Sýrada Olduðunu Bulan Program
/*
char ch;
int sira;
...
printf("Seri = %f", seri);
	*/
	...
	// devam edip etmeme gibi durumlar do while ile yapýlýr.
		...
		//8 Seri Deðeri Hesaplamada Programa Girilen Deðere Göre Devam Koþulu Eklemek
		/*
	...
	*/
	...
	//9 Sýnýftaki Öðrencileriden Boyunun 150 cm e En yakýn Öðrenciyi Bulmak
	/*
...
printf("\n%d numarali ogrenci %d cm boyuyla %d cm e en yakindir", minno, minboy, tam);
	...
	*/
	...
	//10 Tavþanlarýn Sayýsýnýn Kuþlarýn Sayýsýný Kaç Yýl Sonra Geçeceðini Bulan Program
	/*
